...
the StarkNet platform. Pivoting from our initial idea, we embarked on an
equally, if not more ambitious journey: leveraging account abstraction for the
creation of a DeFi tool that can be accessed directly from Telegram like
unibot tool on eth.

We belive this tool may facilitate the use and adoption of starknet and was a
