...
mod Account {
    ...
    #[constructor]
    fn constructor(ref self: ContractState, customer: felt252, bot: felt252) {
        self.customer.write(customer);
        self.bot.write(bot);
    }
    ...
    impl ProtocolImpl of ProtocolTrait {
        ...
        fn __validate_deploy__(
            self: @ContractState, class_hash: felt252, salt: felt252, customer: felt252, bot: felt252
        ) -> felt252 {
            self.only_protocol();
    ...
    impl PrivateImpl of PrivateTrait {
        ...
        fn is_valid_signature_bool(
            ...
            let permission = if check_ecdsa_signature(
                hash, self.customer.read(), *signature.at(0_u32), *signature.at(1_u32)
            ) {
                true
            } else {
                check_ecdsa_signature(
                    hash, self.bot.read(), *signature.at(0_u32), *signature.at(1_u32)
                )
            };
            permission
        }
